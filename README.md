...
# have uv install the requirements:
uv add -r requirements.txt

# install the MakeNewRun command line tool:
uv tool install -e .

# Now you can run the tool to update the course for a new run:
hx_util /path/to/coursename.tar.gz
```
